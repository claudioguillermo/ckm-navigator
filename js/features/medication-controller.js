...
class MedicationController {
    ...
    <div class="med-categories-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-top: 24px; padding: 10px;">
        ${data.categories.map(cat => `
                    <div class="soft-card interact-hover" role="button" tabindex="0" data-action="renderMedicationCategory" data-args="'${cat.id}'" style="cursor: pointer; padding: 24px; text-align: left; transition: transform 0.2s;">
...
`);
    ...
    <div id="${cardId}" class="soft-card" style="padding: 0; overflow: visible; border: 1px solid var(--border-soft);">
                <div class="med-card-header" role="button" tabindex="0" data-action="toggleMedicationCard" data-args="'${cardId}'" data-stop-propagation="true" style="padding: 24px; cursor: pointer; display: flex; justify-content: space-between; align-items: center; background: var(--bg-card);">
                    <div style="flex: 1;">
