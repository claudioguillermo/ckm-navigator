...
app.use((req, res, next) => {
    ...
    res.setHeader('Content-Security-Policy', "default-src 'self'; script-src 'self' https://cdn.jsdelivr.net https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: https:; connect-src 'self' https://dashscope-us.aliyuncs.com https://va.vercel-scripts.com; worker-src 'self'; object-src 'none'; base-uri 'self'; form-action 'self';");
    next();
});
