...
class ChatController {
    ...
    renderChatHistory() {
        ...
        if (this.app.chatHistory.length === 0) {
            ...
            suggestions.forEach(text => {
                ...
                btn.addEventListener('mouseover', () => { btn.style.background = 'var(--accent-red-light)'; });
    ...
    minimizeChat() {
        ...
        if (isMinimized) {
            ...
            sidebar.setAttribute('aria-label', 'Open AI Health Assistant');
    ...
    async sendSidebarChatMessage() {
        ...
        DOMUtils.safeSetHTML(loadingDiv, '<span></span><span></span><span></span>');
